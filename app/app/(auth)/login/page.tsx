...
export default function LoginPage() {
  return (
    <div className="mx-5 border border-stone-200 py-10 dark:border-stone-700 sm:mx-auto sm:w-full sm:max-w-md sm:rounded-lg sm:shadow-md">
      <Image
        alt="Kariah.me Administrative Login"
        width={200}
        height={200}
        className="relative mx-auto h-auto w-auto dark:scale-110 dark:rounded-full dark:border dark:border-stone-400"
        src={logo}
      />
